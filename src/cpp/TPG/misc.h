...
void prepareInFile(ifstream&,const char*, const char*,int,int,int,int);
void prepareOutFile(ofstream&,const char*, const char*,int,int,int,int);
#endif
